...
import { Receipt, CheckCircle2, Clock, AlertCircle, Percent } from "lucide-react"
...
export default async function ConsultantPaymentsPage({
  ...
  const pendingCommissionBookings = await prisma.booking.findMany({
    where: {
      consultantId,
  ...
  return (
    <>
      <Header
        title="Pagamentos"
        subtitle="Faturas mensais e comissões de venda"
      />
      <div className="flex-1 p-6 space-y-6">
        ...
        {/* Commission bookings awaiting sale price */}
